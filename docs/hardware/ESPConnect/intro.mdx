...
- https://www.youtube.com/watch?v=-nhDKzBxHiI
...
- **Preview (development build)**  
  ...
  This version is automatically built from the `main` branch and may include new fix, features, experiments, or breaking changes.
...
ESPConnect is released under the MIT License. See [LICENSE](https://github.com/thelastoutpostworkshop/ESPConnect/blob/main/LICENSE) for the full text.

## Docs

-https://www.elektroda.com/news/news4157511.html
